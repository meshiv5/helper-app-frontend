...
export default function EditForm() {
  const { editPostDetails } = useSelector((s) => s.auth);
  const [details, setDetails] = useState({
    task: editPostDetails.task,
  ...
  const handleClick = async () => {
    try {
      setDetails({ ...details });
      let res = await axios.patch(`${process.env.server}service/${editPostDetails._id}`, details, {
        headers: {
          authorization: localStorage.getItem("helperApp"),
        },
      });
      if (res.data === "Service updated") {
        toast({
          title: "Success.",
      ...
      <Box borderRadius="lg" m={{ base: 5, md: 16, lg: 10 }} p={{ base: 5, lg: 16 }}>
        <Box>
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            ...
            >
              Please update the service details
            </Heading>
                ...
                <VStack spacing={5}>
                  ...
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      ...
                      <Input value={details.pay} type="number" name="pay" placeholder="Price" onChange={handleChange} />
                    </InputGroup>
                  </FormControl>
                  ...
                  <FormControl isRequired>
                    ...
                    <Textarea value={details.description} onChange={handleChange} name="description" placeholder="Your Task" rows={6} resize="none" />
                  </FormControl>
