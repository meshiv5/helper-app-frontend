...
const Room = () => {
  ...
  useEffect(() => {
    ...
    socketRef.current.on("full", () => {
      window.location.href = "/videos/chat";
    });
  ...
  return (
    <div>
      ...
      <Button colorScheme="teal" variant="solid" onClick={toggleMic} type="button">
        {micActive ? "Mute Mic " : "UnMute Mic"}
      </Button>
      <Button colorScheme="yellow" variant="solid" onClick={leaveRoom} type="button">
        Leave
      </Button>
      <Button colorScheme="green" variant="solid" onClick={toggleCamera} type="button">
